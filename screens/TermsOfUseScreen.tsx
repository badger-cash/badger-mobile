...
All title, ownership and intellectual property rights in and to the Service are owned by Badger or its licensors. You acknowledge and agree that the Service contains proprietary and confidential information that is protected by applicable intellectual property and other laws. Except as expressly authorized by Badger, you agree not to copy, modify, rent, lease, loan, sell, distribute, perform, display or create derivative works based on the Service, in whole or in part. Badger issues a license for Badger, found [here](https://github.com/badger-cash/badger/blob/develop/LICENSE) and [here](https://github.com/badger-cash/badger-mobile/blob/develop/license). For information on other licenses utilized in the development of Badger, please see our Site source code at: [https://github.com/badger-cash/badger](https://github.com/badger-cash/badger), and our App source code at :[https://github.com/badger-cash/badger-mobile](https://github.com/badger-cash/badger-mobile)
...
const ViewTermsOfUseScreen = ({ navigation }) => {
  return (
    <ScreenView>
      <Spacer small />
      <H2 center>Terms of Use</H2>
